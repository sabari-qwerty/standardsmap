    ...
    for _ in find_all_h1:
        ...
        for __ in find_all_h3:
            ...
            try:
                ...
                select_data = browser.find_elements(
                ...
                for _num_ in range(len(select_data)):
                    ...
                    select_one = select_data[_num_].get_attribute(
                        "innerText").split('\n')

                    select_list = []
                    if select_one:
                        single_colum = [
                            data for data in select_one if data][:-1]
...
def resources(id):
    ...
    for row in select_row:
        ...
        if "<h1 " in html:
            ...
            list_data.append(["", row.find_element(
...
def governance(id):
    ...
    for _ in range(len(select_all_details)):
        ...
        text = select_all_details[_].find_element(
            By.TAG_NAME, 'h2').get_attribute('innerText')

        select_container = select_all_expand_details[_].find_element(
            By.CSS_SELECTOR, '.container')

        select_all_row = select_container.find_elements(
            By.CSS_SELECTOR, ".row.pb-3.col-12.justify-content-between.ng-star-inserted")
        __dic = {}
        for row in select_all_row:
            ...
            if "<fa-icon " in row.get_attribute('innerHTML'):
                class_ = row.find_element(
                    By.TAG_NAME, "svg").get_attribute('class')
...
def howToComply(id):
    ...
    for _num in range(len(select_all_details)):
        ...
        text = select_all_details[_num].find_element(
            By.TAG_NAME, 'h2').get_attribute("innerText")
        print(text)
        ...
        soup_single_div_data = BeautifulSoup(str(select_table),  'html.parser').find_all(
            'div', class_="row pb-3 col-12 ng-star-inserted")
...
data = ['1080',  '1090', '11', '112', '118', '119', '120', '120934', '124', '127', '128', '129', '13', '131', '136', '138', '139', '14', '140', '141', '142', '142369', '142370', '142371', '143', '144', '145', '145236', '146', '148', '150', '152', '153', '154', '155', '156', '15658', '15684', '15687', '15689', '157', '158', '159', '16', '160', '161', '163', '164', '165', '166', '16690', '167', '169', '170', '172', '173', '174', '175', '176', '177', '178', '179', '18', '181', '182', '184', '186', '187', '189', '19', '191919', '193', '194', '195', '196', '197', '2', '200', '200397', '200398', '201354', '202', '2020', '202720', '204', '2050', '206', '2099', '21', '211000', '21100101', '211005', '211006', '211007', '213', '214', '215', '234', '234568', '235', '236', '237', '239', '24', '241', '242', '243', '244', '245', '248', '249', '250', '254', '255', '256', '26', '260', '261', '263', '265', '267', '271118', '276', '278', '279', '282', '283', '284', '285', '287', '288', '291', '293', '294', '295', '297', '298', '299', '30', '301', '302', '31', '311', '314', '33', '331', '333', '338', '34', '340', '341', '342', '343', '344', '345', '347', '348', '3490', '3491', '35', '36', '364758', '365',
        '366', '37', '370', '379', '38', '380', '381', '384', '385', '386', '390', '391', '396', '40', '401', '4011', '402', '403', '405', '407', '408', '41', '4117', '416', '420', '422', '423', '425', '427', '428', '429', '4317', '434', '435', '436', '437', '438', '441', '4417', '442', '443', '444', '448', '45', '451', '45346', '459', '4596', '46', '462', '463', '464', '467', '468', '47', '470', '475987', '481', '482', '484', '485', '488', '49', '490', '494', '495', '496', '497', '498', '499', '5', '501', '503', '504', '510', '511', '512', '513', '516546', '519', '526', '527', '53', '535', '538', '539', '54', '547', '553', '555', '556', '558', '559', '56', '561', '562', '563', '564', '566', '567', '5673', '5697', '56972', '57', '58', '583', '59', '6', '60', '600', '61', '64', '647', '65', '67', '674', '677', '680', '685', '698', '7', '700', '701', '702', '707', '712', '7281', '7282', '7283', '729', '73', '730', '731', '732', '733', '734', '76', '767902', '777777', '78651', '789', '8013', '803', '8041', '8042', '8043', '8047', '8048', '8052', '859', '863', '868686', '870', '891', '897952', '898989', '9', '903', '905', '906', '907', '908', '91', '93268', '9367', '98379', '98731', '98759']
